...
public class DrugGroupWithDrugInfo {
    private UUID id;
    ...
    public static DrugGroupWithDrugInfo fromDrugGroup(DrugGroup drugGroup, Function<List<UUID>, List<Drug>> populateDrugs) {
        return new DrugGroupWithDrugInfo(
                drugGroup.getId(),
                drugGroup.getUserId(),
